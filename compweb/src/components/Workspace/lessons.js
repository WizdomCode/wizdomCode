...
export const SENIOR_UNIT_LESSONS = [
    ...
    [
        [{ category: "5 Problems", lessonName: "Implementation", imgPath: "/open.png", problemIds: ["Epidemiology"] },
        { category: "4 Problems", lessonName: "AdHoc", imgPath: "/open.png", problemIds: ["Epidemiology"] }],
        [{ category: "7 Problems", lessonName: "Recursion", imgPath: "/open.png", problemIds: ["Epidemiology"] }],
        [{ category: "1 Problem", lessonName: "Data Structures", imgPath: "/open.png", problemIds: ["Epidemiology"] },
        { category: "4 Problems", lessonName: "Graph Theory", imgPath: "/open.png", problemIds: ["Epidemiology"] }],
        [{ category: "6 Problems", lessonName: "Math", imgPath: "/open.png", problemIds: ["Epidemiology"] }],
    ], 
    [
        [{ category: "4 Problems", lessonName: "Data Structures", imgPath: "/open.png", problemIds: ["Epidemiology"] },
        { category: "5 Problems", lessonName: "Graph Theory", imgPath: "/open.png", problemIds: ["Epidemiology"] }],
        [{ category: "4 Problems", lessonName: "Dynamic Programming", imgPath: "/open.png", problemIds: ["Epidemiology"] }],
        [{ category: "2 Problems", lessonName: "Math", imgPath: "/open.png", problemIds: ["Epidemiology"] }]
    ]
];
...
export const BRONZE_UNIT_LESSONS = [
    [
        [{ category: "5 Problems", lessonName: "Sorting", imgPath: "/open.png", problemIds: ["Epidemiology"] },
        ...
        [{ category: "7 Problems", lessonName: "Ad Hoc", imgPath: "/open.png", problemIds: ["Epidemiology"] },
        { category: "7 Problems", lessonName: "Greedy", imgPath: "/open.png", problemIds: ["Epidemiology"] }],
        [{ category: "7 Problems", lessonName: "Data Structures", imgPath: "/open.png", problemIds: ["Epidemiology"] },
        { category: "7 Problems", lessonName: "Graph Theory", imgPath: "/open.png", problemIds: ["Epidemiology"] }],
...
export const GOLD_UNIT_LESSONS = [
    [
        [{ category: "7 Problems", lessonName: "Dynamic Programming", imgPath: "/open.png", problemIds: ["Epidemiology"] }],
...
export const PLAT_UNIT_LESSONS = [
    [
        ...
        [{ category: "5 Problems", lessonName: "Dynamic Programming", imgPath: "/open.png", problemIds: ["Epidemiology"] }],
